...
void dem_xuong(UNSIGNED int8  gioi_han_tren, gioi_han_duoi)    //ket hop bien TOAN CUC san_pham nam trong gioi han tren và duoi
{
   t0 = get_timer0 ();
...
void dem_len(UNSIGNED int8  gioi_han_duoi, gioi_han_tren)    //ket hop bien TOAN CUC san_pham nam trong gioi han tren và duoi
{
   t0 = get_timer0 ();
   //!      UNSIGNED int8 san_pham = 6;

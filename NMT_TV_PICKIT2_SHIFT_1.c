...
#USE        I2C(MASTER,SLOW,SDA=PIN_B0,SCL=PIN_B1)       //tim hieu phan cung MBI5026
#USE        DELAY(CLOCK=20000000)      //20MHz
#USE        rs232(baud=9600, xmit=PIN_C6,rcv=PIN_C7)     //UART, C6=Tx, C7=Rx, xmit??, rcv???
//NUT NHAN:
#DEFINE  BT0     PIN_B5
#DEFINE  BT1     PIN_B4
#DEFINE  BT2     PIN_B3
...
//A là module o tren, B la module o duoi, Trang 10. Chac vay??
...
INT1 PHIM_BT0(UNSIGNED INT16 DL)       //chuc nang gi
{  
    IF(!INPUT(BT0))     //nhan phim
    {  
      DL_BTN++;      //0 - 1
      IF(DL_BTN==1) RETURN(1);   //tra ve 1
      ELSE
      {
         IF (DL_BTN>= DL)        //??
         DL_BTN = 0;
